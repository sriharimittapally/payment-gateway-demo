...
export default function Checkout() {
  ...
  // ⭐ Empty cart UI instead of blank page
  if (cart.length === 0) {
    return (
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <motion.div
        ...
        className="glass-card rounded-2xl border border-gray-300 overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="p-6 space-y-3">
          ...
          {cart.map((item) => (
            <div
              key={item.id}
              className="flex items-center border gap-3 p-3 rounded-lg bg-secondary/50"
            >
              <img
                src={item.image}
                alt={item.name}
